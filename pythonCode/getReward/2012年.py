...
def gteData(url, classAttr, exceName):
    ...
    dict = {}
    table = bs.findAll(name="table", attrs={"style":'PADDING-BOTTOM: 0pt; PADDING-LEFT: 0pt; PADDING-RIGHT: 0pt; BORDER-COLLAPSE: collapse; MARGIN-LEFT: 4.6pt; PADDING-TOP: 0pt; mso-table-layout-alt: fixed'})
    i = 0
...
url = "http://www.most.gov.cn/ztzl/gjkxjsjldh/jldh2012/jldh12jlgg/201301/t20130117_99203.htm"
# 2002年 一等奖二等奖在两个表格
classAttr = ["一等奖", "二等奖"]
exceName = "2012年度国家科学技术进步奖目录"
