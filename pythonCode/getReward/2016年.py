...
def gteData(url, classAttr, exceName):
    ...
    dict = {}
    table = bs.findAll(name="table", attrs={"class":'2 FCK__ShowTableBorders2'})
    i = 0
...
url = "http://www.most.gov.cn/ztzl/gjkxjsjldh/jldh2016/jldh16jlgg/201701/t20170105_130203.htm"
# 2002年 一等奖二等奖在两个表格
classAttr = ["一等奖", "二等奖"]
exceName = "2016年度国家科学技术进步奖目录"
