...
def gteData(url, classAttr, exceName):
    ...
    dict = {}
    table = bs.findAll(name="table", attrs={"style":'PADDING-BOTTOM: 0pt; PADDING-LEFT: 5.4pt; PADDING-RIGHT: 5.4pt; BORDER-COLLAPSE: collapse; PADDING-TOP: 0pt; mso-table-layout-alt: fixed'})
    i = 0
...
url = "http://www.most.gov.cn/ztzl/gjkxjsjldh/jldh2013/jldh13jlgg/201401/t20140107_111218.htm"
# 2002年 一等奖二等奖在两个表格
classAttr = ["一等奖", "二等奖"]
exceName = "2013年度国家科学技术进步奖目录"
