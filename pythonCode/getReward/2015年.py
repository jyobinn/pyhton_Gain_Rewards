...
def gteData(url, classAttr, exceName):
    ...
    dict = {}
    table = bs.findAll(name="table", attrs={"class":'MsoNormalTable'})
    i = 0
...
url = "http://www.most.gov.cn/ztzl/gjkxjsjldh/jldh2015/jldh15jlgg/201601/t20160106_123351.htm"
# 2002年 一等奖二等奖在两个表格
classAttr = ["一等奖", "二等奖"]
exceName = "2015年度国家科学技术进步奖目录"
