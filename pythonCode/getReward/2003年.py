...
def gteData(url, classAttr, exceName):
    ...
    bs = BeautifulSoup(html_str, "html.parser")
    dict = {}
    table = bs.findAll(name="table", attrs={"width": "100%", "border": "1"})
    i = 0
...
url = "http://www.most.gov.cn/ztzl/gjkxjsjldh/jldh2003/jbj/jbjml.htm"
# 2002年 一等奖二等奖在两个表格
classAttr = ["特等奖","一等奖", "二等奖"]
exceName = "2003年度国家科学技术进步奖目录"
