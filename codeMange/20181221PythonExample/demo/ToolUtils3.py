...
def doLoopByUrl(obj, url):
    ...
    obj.list = getPlaceList(getBytesByURL(url))

    sleep(5)
    for obj_1st in obj.list:
        doLoopByUrl(obj_1st, obj_1st.url)
...
if __name__ == '__main__':
    ...
    url = "https://xingzhengquhua.51240.com/330000000000__xingzhengquhua/"
    # i = 0
    # url = "https://xingzhengquhua.51240.com/"
    list_1st = []
    # i += 1
    ...
    #         sleep(5)
    country = Place()
    doLoopByUrl(country, url)
    # global list
    list_1st = country.list
    for obj_1st in list_1st:
        ...
        for obj_2st in obj_1st.list:
            ...
            for obj_3st in obj_2st.list:
                ...
                for obj_4st in obj_3st.list:
                    print("\t\t\t" + obj_4st.nameCn)
                    for obj_5st in obj_4st.list:
                        print("\t\t\t\t" + obj_5st.nameCn)
